...
import proj.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner { // execute run method when the application starts
  ...
  public void run(String... args) throws Exception {
    ...
    Order o2 = new Order(null, Instant.parse("2019-06-20T19:23:07Z"), OrderStatus.WAITING_PAYMENT, u2);
    Order o3 = new Order(null, Instant.parse("2019-06-20T19:33:07Z"), OrderStatus.WAITING_PAYMENT, u1);
